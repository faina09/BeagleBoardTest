...
var schema = new Schema(fs.readFileSync(path.resolve(__dirname,'feeds.desc')));
// The "Feed" message.
...
var aFeed = Feed.parse(Feed.serialize({
    entry: [{}, {}]
}));
